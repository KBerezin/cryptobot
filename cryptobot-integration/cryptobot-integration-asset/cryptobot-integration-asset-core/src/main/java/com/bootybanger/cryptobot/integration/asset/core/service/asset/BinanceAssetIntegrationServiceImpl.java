...
@Service
public class BinanceAssetIntegrationServiceImpl extends AbstractAssetIntegrationService {
    public BinanceAssetIntegrationServiceImpl(AssetDTOMapper mapper, @Qualifier("binanceAssetClient") ExchangeAssetClient client) {
        super(mapper, client);
    }
}
