...
@Service
public class GateAssetIntegrationServiceImpl extends AbstractAssetIntegrationService {
    public GateAssetIntegrationServiceImpl(AssetDTOMapper mapper, @Qualifier("gateAssetClient") ExchangeAssetClient client) {
        super(mapper, client);
    }
}
